...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : EnergyDownSW_Pin EnergyUpSW_Pin HealthDownSW_Pin HealthUpSW_Pin */
  GPIO_InitStruct.Pin = EnergyDownSW_Pin|EnergyUpSW_Pin|HealthDownSW_Pin|HealthUpSW_Pin;
